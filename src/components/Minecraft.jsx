...
Command: npx gltfjsx@6.5.3 Minecraft.gltf 
*/
...
export function Minecraft(props) {
  const { nodes, materials } = useGLTF('/recursos/minecraft/Minecraft.gltf')
  return (
    <group {...props} dispose={null}>
      ...
      <mesh geometry={nodes.cubo_ladrillo.geometry} material={materials.Pared2} />
      ...
      <mesh geometry={nodes.chest_1.geometry} material={materials['Caja 2']} />
      <mesh geometry={nodes.chest_2.geometry} material={materials['Caja 2']} />
      ...
      <group position={[0, -2, 0]}>
        <mesh geometry={nodes.Cube296.geometry} material={materials.block_4_1} />
        <mesh geometry={nodes.Cube296_1.geometry} material={materials.block_4} />
      </group>
      <mesh geometry={nodes.Cube122.geometry} material={materials.Tronco_Tapa} />
      ...
      <mesh geometry={nodes.Cube176_1.geometry} material={materials.HornoParedes} />
      <mesh geometry={nodes.Cube176_2.geometry} material={materials.Horno} />
      <mesh geometry={nodes.Cube186.geometry} material={materials['table front']} />
...
useGLTF.preload('/recursos/minecraft/Minecraft.gltf')
